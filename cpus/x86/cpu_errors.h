"instruction not supported on selected architecture", ERROR,
	...
	"base register expected", ERROR, "scale factor without index register",
	ERROR, /* 5 */
	"missing ')' in baseindex addressing mode", ERROR,
	"redundant %s prefix ignored", WARNING, "unknown register specified",
	ERROR, "using register %%%s instead of %%%s due to '%c' suffix",
	WARNING, "%%%s not allowed with '%c' suffix", ERROR, /* 10 */
	"illegal suffix '%c'", ERROR,
	"instruction has no suffix and no register operands - size is unknown",
	ERROR, "UNUSED", ERROR, "memory operand expected", ERROR,
	"you cannot pop %%%s", ERROR, /* 15 */
	"translating to %s %%%s,%%%s", WARNING, "translating to %s %%%s",
	WARNING, "absolute scale factor required", ERROR,
