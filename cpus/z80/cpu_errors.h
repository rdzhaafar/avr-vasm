"index offset out of bounds (%d)", ERROR, "Opcode not supported by %s (%s)",
	ERROR, "Index registers not available on %s", ERROR,
	...
	"Opcode not supported by %s (%s) but it can be emulated (-rcmemu)",
	ERROR, "%s specifier is only valid for Rabbit processors", ERROR,
