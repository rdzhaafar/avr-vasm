"instruction not supported on selected architecture", ERROR,
	...
	"cannot make rotated immediate from PC-relative offset (0x%lx)",
	ERROR, /*05*/
	...
	"not a valid ARM register", ERROR, "PC (r15) not allowed in this mode",
	ERROR, /*10*/
	...
	"data size %d not supported", ERROR, "illegal addressing mode: %s",
	ERROR, "signed/halfword ldr/str doesn't support shifts", ERROR,
