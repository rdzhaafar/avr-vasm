"instruction not supported on selected architecture", FATAL | ERROR,
	"illegal addressing mode", ERROR, "invalid register list", ERROR,
	"missing ) in register indirect addressing mode", ERROR,
	"address register required", ERROR, "bad size extension",
	ERROR, /* 05 */
	...
	"no extension allowed here", WARNING, "illegal scale factor",
	ERROR, /* 10 */
	"can't scale PC register", WARNING, "index register expected", ERROR,
	"too many ] in memory indirect addressing mode", ERROR,
	"missing outer displacement", ERROR, "%c expected", ERROR, /* 15 */
	"can't use PC register as index", ERROR, "double registers in list",
	WARNING, "data register required", ERROR,
	...
	"need 32 bits to reference a program label", WARNING, "option expected",
	ERROR, "absolute value expected", ERROR,
	...
	"%ld to fix",
	WARNING, "branch destination out of range", ERROR,
	"displacement out of range", ERROR, "absolute displacement expected",
	ERROR, /* 30 */
	"unknown option %c%c ignored", WARNING,
	"absolute short address out of range", ERROR,
	"deprecated instruction alias", WARNING, "illegal opcode extension",
	FATAL | ERROR, "extension for unsized instruction ignored",
	WARNING, /* 35 */
	...
	"data out of range", ERROR, "data has illegal type", ERROR, /* 40 */
	"illegal combination of ColdFire addressing modes", ERROR,
	"FP register required", ERROR, "unknown cpu type", ERROR,
	"register expected", ERROR, "link.w changed to link.l",
	WARNING, /* 45 */
	...
	"operand optimized: %s", MESSAGE, "operand translated: %s",
	MESSAGE, /* 50 */
	"instruction optimized: %s", MESSAGE, "instruction translated: %s",
	MESSAGE, "branch optimized into: b<cc>.%c", MESSAGE,
	...
	"small data mode is not enabled", ERROR, "division by zero",
	WARNING, /* 60 */
	"can't use B%d register as index", ERROR, "register list on both sides",
	ERROR,
	"\"%s\" directive was replaced by an instruction with the same name",
	NOLINE | WARNING,
