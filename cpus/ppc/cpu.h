...
#define VL7450                                                                 \
	(CPU_TYPE_405 | CPU_TYPE_476 | CPU_TYPE_BOOKE | CPU_TYPE_7450 |        \
	 CPU_TYPE_VLE)
...
#define BBO(op, bo, aa, lk)                                                    \
	(B((op), (aa), (lk)) | ((((uint32_t)(bo)) & 0x1f) << 21))
#define BBOCB(op, bo, cb, aa, lk)                                              \
	(BBO((op), (bo), (aa), (lk)) | ((((uint32_t)(cb)) & 0x3) << 16))
#define DSO(op, xop) (OP(op) | ((xop)&0x3))
#define M(op, rc) (OP(op) | ((rc)&1))
#define MME(op, me, rc) (M((op), (rc)) | ((((uint32_t)(me)) & 0x1f) << 1))
#define MD(op, xop, rc) (OP(op) | ((((uint32_t)(xop)) & 0x7) << 2) | ((rc)&1))
#define MDS(op, xop, rc) (OP(op) | ((((uint32_t)(xop)) & 0xf) << 1) | ((rc)&1))
...
#define XFXM(op, xop, fxm) (X((op), (xop)) | ((((uint32_t)(fxm)) & 0xff) << 12))
#define XSPR(op, xop, spr)                                                     \
	(X((op), (xop)) | ((((uint32_t)(spr)) & 0x1f) << 16) |                 \
	 ((((uint32_t)(spr)) & 0x3e0) << 6))
#define XDS(op, xop, at) (X((op), (xop)) | ((((uint32_t)(at)) & 1) << 25))
