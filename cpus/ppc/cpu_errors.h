"%s", WARNING, "instruction not supported on selected architecture", ERROR,
	"constant integer expression required", ERROR,
	"trailing garbage in operand", WARNING, "illegal operand type", ERROR,
	"missing closing parenthesis in load/store addressing mode",
	ERROR, /* 05 */
	"relocation does not allow hi/lo modifier", ERROR,
	"multiple relocation attributes", ERROR, "multiple hi/lo modifiers",
	ERROR, "data size %d not supported", ERROR, "data has illegal type",
	ERROR, /* 10 */
