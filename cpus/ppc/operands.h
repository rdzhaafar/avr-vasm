...
{
	if (value == 0 || (uint32_t)value == ((insn >> 21) & 0x1f))
...
{
	return insn | (((32 - value) & 0x1f) << 11) | ((value & 0x1f) << 6) |
	       (31 << 1);
}
...
static uint32_t insert_extrwi(uint32_t insn, int32_t value, const char** errmsg)
{
	if (value < 1 || value > 32)
		*errmsg = "value out of range (1-32)";
	return insn | ((value & 0x1f) << 11) | (((32 - value) & 0x1f) << 6) |
	       (31 << 1);
}
...
static uint32_t insert_inslwi(uint32_t insn, int32_t value, const char** errmsg)
{
	...
	return (insn & ~0xfffe) | (((32 - value) & 0x1f) << 11) |
	       ((value & 0x1f) << 6) | ((((value + n) - 1) & 0x1f) << 1);
}
...
static uint32_t insert_insrwi(uint32_t insn, int32_t value, const char** errmsg)
{
	...
	if (value + n > 32)
		*errmsg = "sum of last two operands out of range (1-32)";
	return (insn & ~0xfffe) | (((32 - (value + n)) & 0x1f) << 11) |
	       ((value & 0x1f) << 6) | ((((value + n) - 1) & 0x1f) << 1);
}
...
static uint32_t insert_clrlslwi(uint32_t insn, int32_t value,
				const char** errmsg)
{
	int32_t b = (insn >> 6) & 0x1f;
	if (value > b)
		*errmsg = "n (4th oper) must be less or equal to b (3rd oper)";
	return (insn & ~0x7c0) | ((value & 0x1f) << 11) |
	       (((b - value) & 0x1f) << 6) | (((31 - value) & 0x1f) << 1);
}
