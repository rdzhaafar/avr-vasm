"illegal operand types", ERROR, "unknown mnemonic <%s>", ERROR,
	"unknown section <%s>", ERROR, "no current section specified", ERROR,
	"internal error %d in line %d of %s", ERROR | FATAL,
	"symbol <%s> redefined", WARNING, /*  5 */
	"%c expected", WARNING,
	"cannot resolve section <%s>, maximum number of passes reached",
	NOLINE | ERROR | FATAL,
	...
	"multiple input files", NOLINE | ERROR, "could not open <%s> for input",
	ERROR | FATAL, "could not open <%s> for output", NOLINE | ERROR | FATAL,
	"unknown option <%s>", NOLINE | ERROR, "no input file specified",
	NOLINE | ERROR | FATAL, /* 15 */
	"could not initialize output module <%s>", NOLINE | ERROR | FATAL,
	"out of memory", NOLINE | ERROR | FATAL,
	"symbol <%s> recursively defined", ERROR | FATAL, "fail: %s", ERROR,
	"section offset is lower than current pc", ERROR | FATAL, /* 20 */
	"target data type overflow (%d bits)", WARNING, "undefined symbol <%s>",
	NOLINE | ERROR, "trailing garbage after option -%c", NOLINE | WARNING,
	...
	"option %s was specified twice", NOLINE | WARNING, "read error on <%s>",
	NOLINE | ERROR | FATAL, "expression must be constant", ERROR, /* 30 */
	"initialized data in bss", WARNING,
	"missing end directive in repeat-block", ERROR | FATAL,
	"#%d is not a valid %smessage", NOLINE | ERROR,
	"relocation not allowed", ERROR, "illegal escape sequence \\%c",
	WARNING, /* 35 */
	"no current macro to exit", ERROR,
	"internal symbol %s redefined by user", ERROR | FATAL,
	"illegal relocation", ERROR, "label name conflicts with mnemonic",
	WARNING, "label name conflicts with directive", WARNING, /* 40 */
	"division by zero", ERROR, "illegal macro argument", ERROR,
	"reloc org is already set", ERROR | FATAL, "reloc org was not set",
	ERROR, "address space overflow", ERROR, /* 45 */
	"bad file-offset argument", ERROR, "assertion \"%s\" failed: %s", ERROR,
	"cannot declare structure within structure", ERROR, "no structure",
	ERROR, "instruction has been auto-aligned", WARNING, /* 50 */
	...
	"data has been auto-aligned", WARNING, "register symbol <%s> redefined",
	ERROR, "cannot evaluate constant huge integer expression", ERROR,
	...
	"repeatedly defined symbol <%s>", ERROR, "macro <%s> does not exist",
	ERROR, "register <%s> does not exist", ERROR,
	...
	"label <%s> redefined", ERROR, "base %d numerical term expected",
	ERROR, /* 75 */
	"section stack overflow", ERROR, "section stack is empty", ERROR,
